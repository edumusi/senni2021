<?php
     ...
     $html = $html ."<head>";
     $html = $html . meta($meta);
     $html = $html . '<link rel="STYLESHEET" href="css/factura_pdf_SENNI.css" type="text/css">';     
     $html = $html . "</head>"; 
    ...
    $cfdisrel = "";
    foreach( $f['CfdisRelacionados']['UUID'] as $c )
            { $cfdisrel = $cfdisrel . $c .'<br>';   }
   ...
   $html = $html .'<body marginwidth="0" marginheight="0">'
					...
					.'	<table cellspacing="0" align="center" cellpadding="0" style="width: 100%;">
						...
						.'	<table cellspacing="0" align="center" cellpadding="0" style="width: 100%;">
							<tbody>								
								<tr> <td width="100%" colspan="2" class="center fondoColor" style="font-size: 8pt;"><strong>CFDI RELACIONADOS </strong> </td> </tr>
								<tr> <td width="50%" class="center" style="font-size: 7pt;"> <strong>TIPO DE RELACIÓN</strong> </td>
									 <td width="50%" class="center" style="font-size: 7pt;"> <strong>CFDI RELACIONADO</strong> </td>									 							 
								</tr>	
                                <tr> <td width="50%" class="center" style="font-size: 7pt;">'.$f['CfdisRelacionados']['TipoRelacion'].' '.$f['factPDF']['tipoRelacionDesc'].'</td>
									 <td width="50%" class="center" style="font-size: 7pt;"> '.$cfdisrel.' </td>
								</tr>																
							</tbody>
						</table> '
						.( ($f['factPDF']['notasCfdiRel']==null || $f['factPDF']['notasCfdiRel']=="") ? "" : 
							'	<table cellspacing="0" align="center" cellpadding="0" style="width: 100%;">
								<tbody>
									<tr> <td width="" class="center fondoColor" style="font-size: 9pt;"><strong>NOTAS</strong> </td> </tr>
									<tr> <td width="" class="left" style="font-size: 9pt;">'.nbs().$f['factPDF']['notasCfdiRel'].' </td> </tr>
								</tbody>
								</table>'
						) 
					 .'</div>'
